...
class TwitterAPI {
  ...
  static Future<void> init() async {
    ...
    var result = await HttpWrapper.post(url, headers: hheader);
  ...
  static Future<String> timeline(String restId) async {
    await HttpWrapper.post('https://api.twitter.com/1.1/jot/client_event.json',
        headers: {
          'authorization':
              'Bearer AAAAAAAAAAAAAAAAAAAAANRILgAAAAAAnNwIzUejRCOuH5E6I8xnZz4puTs%3D1Zv7ttfk8LF81IUq16cHjhLTvJu4FA33AGWWjCpTnA',
        },
    ...
    while (true) {
      ...
      url += '?' +
          params.entries
              ...
              .join('&');
      var res = (await HttpWrapper.getr(
        url,
        headers: header,
      ))
          .body;
