...
class DownloadItemMenu extends StatelessWidget {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        _typeItem(context, Icons.open_in_new, 'URL 열기', 3),
                        _typeItem(context, MdiIcons.contentCopy, 'URL 복사', 2),
                        _typeItem(context, MdiIcons.refresh, '재시도', 1),
                        // _typeItem(context, MdiIcons.viewAgendaOutline, 'srt2', 2),
                        _typeItem(context, MdiIcons.trashCan, '삭제', -1),
                        Expanded(
                          child: Container(),
                        )
                      ],
